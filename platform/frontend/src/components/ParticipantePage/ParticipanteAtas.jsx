    ...
    <div className="relative">
      ...
      {loading ? (
        <div className="py-12 flex justify-center">
          <LoadingSpinner text="A carregar atas..." color="text-sky-700" textClass="text-sky-700 font-light text-sm" />
        </div>
      ) : (
        <>  
          {(!data || data.length === 0) && (
              <div className="text-center py-20  rounded-md mt-4">
                ...
                <p className="text-gray-500 text-lg mt-2">
                  {lastKeyword === "" ? (
                    pagination.total === 1 ? t("no_atas_found_simple") : t("no_atas_found_simple")
                  ) : (
                    <>
                      {pagination.total === 1 ? t("no_atas_found") : t("no_atas_found")}{" "}
...
export default ParticipanteAtas;
