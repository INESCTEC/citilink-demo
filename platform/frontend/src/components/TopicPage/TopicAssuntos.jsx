    ...
    <div className="relative">
              ...
              <div className="flex flex-row gap-0">
                <div className="relative flex-grow">
                  <input 
                    type="text" 
                    name="search"
                    placeholder={t("search_subjects_placeholder", "Pesquisar assuntos...")} 
      ...
      {loading ? (
        <div className="py-12 flex justify-center">
          <LoadingSpinner text={t("loading_subjects", "A carregar assuntos...")} color="text-sky-700" textClass="text-sky-700 font-light text-sm" />
        </div>
      ) : (
        <>
          {pagination.total === 0 && (
            <div className="text-center py-20 rounded-md mt-4">
              ...
              <p className="text-gray-500 text-lg mt-2">
                {lastKeyword === "" ? (
                  t("no_subjects_found_simple", "Não foram encontrados assuntos.")
                ) : (
                  <>
                    {t("no_subjects_found", "Não foram encontrados assuntos")}{" "}
